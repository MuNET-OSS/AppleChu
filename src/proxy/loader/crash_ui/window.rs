...
use windows_sys_loader::Win32::Foundation::{HWND, LPARAM, LRESULT, RECT, WPARAM};
use windows_sys_loader::Win32::Graphics::Gdi::{
    CreateFontW, CreateSolidBrush, SetBkColor, SetTextColor, FW_NORMAL, HBRUSH,
};
use windows_sys_loader::Win32::System::LibraryLoader::GetModuleHandleW;
use windows_sys_loader::Win32::UI::WindowsAndMessaging::{
...
static mut UI_FONT: windows_sys_loader::Win32::Graphics::Gdi::HFONT = std::ptr::null_mut();
...
unsafe fn enable_dark_titlebar(hwnd: HWND, dark: bool) {
    ...
    let module = windows_sys_loader::Win32::System::LibraryLoader::LoadLibraryW(dwmapi.as_ptr());
    if module.is_null() {
        return;
    }
    type SetAttrFn = unsafe extern "system" fn(HWND, u32, *const core::ffi::c_void, u32) -> i32;
    let proc = windows_sys_loader::Win32::System::LibraryLoader::GetProcAddress(
        module,
...
unsafe extern "system" fn wnd_proc(
    ...
    match msg {
        ...
        WM_CTLCOLOREDIT | WM_CTLCOLORSTATIC => {
            let hdc = wparam as windows_sys_loader::Win32::Graphics::Gdi::HDC;
...
unsafe fn open_crash_folder() {
    ...
    let verb = wide("open");
    windows_sys_loader::Win32::UI::Shell::ShellExecuteW(
        std::ptr::null_mut(),
        verb.as_ptr(),
        dir.as_ptr(),
        std::ptr::null(),
