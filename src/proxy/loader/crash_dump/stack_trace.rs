...
use windows_sys_loader::Win32::Foundation::{HANDLE, MAX_PATH};
use windows_sys_loader::Win32::System::Diagnostics::Debug::{
...
use windows_sys_loader::Win32::System::ProcessStatus::{
    GetModuleBaseNameA, GetModuleInformation, MODULEINFO,
};
use windows_sys_loader::Win32::System::Threading::{GetCurrentProcess, GetCurrentThread};

const IMAGE_FILE_MACHINE_I386: u32 = 0x014c;

#[cfg(target_arch = "x86")]
pub(super) type NativeContext = windows_sys_loader::Win32::System::Diagnostics::Debug::CONTEXT;
...
unsafe fn module_from_address(addr: usize) -> Option<*mut c_void> {
    ...
    let ok = windows_sys_loader::Win32::System::LibraryLoader::GetModuleHandleExA(
        flags,
        addr as *const u8,
        &mut module,
    );
