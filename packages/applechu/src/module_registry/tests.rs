...
fn built_in_modules_are_discovered_in_stage_order() {
    ...
    let expected = [
        ...
        ("iohook::init_core", InitStage::PlatformCore, 25),
        ("iohook::serial::init", InitStage::PlatformCore, 30),
        ("platform::amvideo::init", InitStage::Platform, 10),
        ("platform::clock::init", InitStage::Platform, 20),
        ("platform::misc::init", InitStage::Platform, 50),
        ("platform::pcbid::init", InitStage::Platform, 80),
        ("platform::vfs::init", InitStage::Platform, 90),
        ("platform::system::init", InitStage::Platform, 100),
